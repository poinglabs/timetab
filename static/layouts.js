try {
} catch(e) {handleError(e, {location:"nextweeks"})}
...
class NextWeeks {
    ...
    render(selector) {
        try {
            ...
            $("body").on("keyup", function (e) {
                ...
                } catch(e) {handleError(e, {location:"nextweeks keyup 39"})}
            })
            $("body").on("keyup", function (e) {
                try {
                    if (e.keyCode == 37) {
                ...
                } catch(e) {handleError(e, {location:"nextweeks keyup 37"})}
            })
            ...
            $(selector).click(function (e) {
                ...
                } catch(e) {handleError(e, {location:"nextweeks click"})}
            })
        } catch(e) {handleError(e, {location:"nextweeks render"})}
    }
    renderDays() {
        try {
        ...
        } catch(e) {handleError(e, {location:"nextweeks render days"})}
    }
    ...
    fillDays(total_days, container) {
        ...
        } catch(e) {handleError(e, {location:"nextweeks fill days"})}
    }
    renderEvents(events) {
        try {
        ...
        } catch(e) {handleError(e, {location:"nextweeks render events"})}
    }
    renderNextHoliday(events) {
        ...
        } catch(e) {handleError(e, {location:"nextweeks render next holiday"})}
    }
    ...
    openAddEvent(date, description) {
        try {
            ...
            $(".modal-event input[type='submit']").click(function () {
                try {
                    ...
                    me.renderDays()
                } catch(e) {handleError(e, {location:"nextweeks openAddEvent submit click"})}
            })
            $(".modal-event .modal-event__btn-delete").click(function () {
                try {
                    ...
                    me.date.setDate(me.date.getDate() - 2 * me.days_col)
                    me.renderDays()
                } catch(e) {handleError(e, {location:"nextweeks openAddEvent delete click"})}
            })
            $("#modal").click(function (e) {
                try {
                    if ($(e.target).is("#modal")) $("#modal").hide()
                } catch(e) {handleError(e, {location:"nextweeks openAddEvent modal click"})}
            })
            $("#modal").keyup(function(e) {
                ...
                } catch(e) {handleError(e, {location:"nextweeks openAddEvent keyup escape"})}
            })
        ...
        } catch(e) {handleError(e, {location:"nextweeks openAddEvent"})}
    }
    ...
    removeEvent(events, remove_event) {
        ...
        } catch(e) {handleError(e, {location:"nextweeks remove event"})}
    }
...
class Name {
    constructor(selector) {
        ...
        } catch(e) {handleError(e, {location:"name constructor"})}
    }
    ...
    renderWelcome() {
        ...
        } catch(e) {handleError(e, {location:"name render"})}
    }
    renderInput() {
        try {
            var me = this
        ...
        } catch(e) {handleError(e, {location:"name render input"})}
    }
    validateInput() {
        try {
        ...
        } catch(e) {handleError(e, {location:"name validate input"})}
    }
...
class Clock {
    constructor(selector) {
        ...
        } catch(e) {handleError(e, {location:"clock constructor"})}
    }
    ...
    updateClock() {
        try {
            ...
            m = this.checkTime(m);
            s = this.checkTime(s);
            if (document.querySelector(this.selector)) document.querySelector(this.selector).innerHTML = h + "·" + m + "<span class='c-clock__seconds'>" + s + "</span>";
        } catch(e) {handleError(e, {location:"clock update clock"})}
    }
    checkTime(i) {
...
class Sunhours {
    ...
    constructor(date, selector) {
        try {
            ...
            this.getMoonPhase()
        } catch(e) {handleError(e, {location:"sunohours constructor"})}
    }
    ...
    getPhrases() {
        try {
            ...
            return ""
        } catch(e) {handleError(e, {location:"sunhours get phrases"})}
    }
    ...
    render() {
        ...
        } catch(e) {handleError(e, {location:"sunhours render"})}
    }
    ...
    getMoonPhase() {
        ...
        } catch(e) {handleError(e, {location:"sunhours getMoonPhases"})}
    }
